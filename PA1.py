#Made by Morgan Houston
#Created: 09/20/2020
#PA 1 - Seaching for Solutions

#Used functions from searchGeneric.py
...
import aipython.searchProblem as searchProblem

def test(SearchClass, problem=searchProblem.acyclic_delivery_problem, solutions=[['r123']] ):
    ...
    """
    print("Testing Acyclic Delivery Problem:")
...
# A* query for acyclic delivery problem:
